...
- (void)setNavigationBarBackImage:(NSString *)imageName andXImage:(NSString *)xImageName{

    if([[UIApplication sharedApplication] statusBarFrame].size.height > 20){
         [self.navigationBar setBackgroundImage:[UIImage imageNamed:xImageName] forBarMetrics:UIBarMetricsDefault];
    }else{
